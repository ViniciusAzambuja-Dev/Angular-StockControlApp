...
export class ProductFormComponent implements OnInit, OnDestroy {
  ...
  public addProductForm = this.formBuider.group({
  ...
  public editProductForm = this.formBuider.group({
    name: ['', Validators.required],
    price: ['', Validators.required],
    description: ['', Validators.required],
    amount: [0, Validators.required],
  ...
  public saleProductForm = this.formBuider.group({
    amount: [0, Validators.required],
  ...
  constructor(
    ...
    private productService: ProductsService,   private productsDtService : ProductsDataTransferService,
